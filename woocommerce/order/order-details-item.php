...
<tr
	...
	<td class="woocommerce-table__product-name product-name"
		data-title="<?php echo esc_attr(isset($column_titles['product-name']) ? $column_titles['product-name'] : ''); ?>">
		<?php
	...
	<td class="woocommerce-table__product-total product-total"
		data-title="<?php echo esc_attr(isset($column_titles['product-total']) ? $column_titles['product-total'] : ''); ?>">
