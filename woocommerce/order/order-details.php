...
<section class="woocommerce-order-details">
	...
	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">
		...
		<tbody>
			...
			// Mappe les classes de colonnes à leur titre (à adapter si tu ajoutes des colonnes)
			$column_titles = [
				'product-name' => esc_html__('Produit', 'woocommerce'),
				'product-total' => esc_html__('Total', 'woocommerce'),
				// 'autre-colonne' => 'Titre',
			];
		...
		<tfoot>
			...
			<?php if ($order->get_customer_note()): ?>
				<tr>
					...
					<td><?php echo wp_kses(nl2br(wptexturize($order->get_customer_note())), array('br' => array())); ?>
					</td>
				</tr>
			<?php endif; ?>
		</tfoot>
