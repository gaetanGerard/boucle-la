...
$message = 'À partir de cet page, vous pouvez Ajouter ou modifier un moyen de paiement.';
	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<button type="submit"
					class="woocommerce-Button woocommerce-Button--alt button btn-style alt<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"
					id="place_order"
